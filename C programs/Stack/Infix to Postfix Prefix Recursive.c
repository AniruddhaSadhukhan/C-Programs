//33. Convert an infix expression to corresponding postfix and prefix expression.(recursive method)
#include<stdio.h>
#include<ctype.h>
#include<string.h>
...
void postfix(char *e)	//recursive function for infix to postfix
{
	char x;
